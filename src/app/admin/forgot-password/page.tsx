      ...
      <main className="forgot-password-main">
        <div className="forgot-password-form-container">
          <div className="forgot-password-form-card">
            {!sent ? (
              <>
                <a className="back-button" href="/admin/login">← Back</a>
                <h1 className="login-title">Reset your password</h1>
                <p className="forgot-password-description">Enter your admin email to receive the password reset link.</p>
              ...
              <div className="success-message">
                ...
                <a className="back-to-login-button" href="/admin/login">Back to login</a>
              </div>
            )}
          </div>
        </div>
